...
/* ==========================================
   ...
   IMPORTANT:
   USE SESSION FIRST
   DO NOT REDIRECT ON TRANSIENT ERROR
========================================== */
...
async function loadTodayCheckin(user) {
    ...
    try {
        ...
        console.error(
            "Load today check-in unexpected error:",
            error
        );
...
async function initialize() {
    ...
    /*
       IMPORTANT:
       If there is no session, show the message.
       We do NOT repeatedly redirect.
    */
